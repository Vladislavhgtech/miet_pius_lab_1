...
require_once __DIR__.'/MaxMinSalaries.php';
...
$em2 = new Employee("Wednesday 2022",15,"IncorrectEmployee",150);
$em3 = new Employee($date,22,"CorrectEmployee",300);
$em6 = new Employee($date,21,"CorrectEmployee",450);
